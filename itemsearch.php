...
<body>
<center><h2>Searched Item Data For Modification</h2>
<?php
	$r=$_POST['buid'];
	...
	$sql="select * from items where buid='$r'";
	$rs=mysql_query($sql);
...
<form method="post" action="itemssave.php">
...
Equipment is:  <input type="text" name="items" value="<?php echo $record[2];?>"><br>
Category is:  <input type="text" name="category" value="<?php echo $record[3];?>"><br>
Number of item is:  <input type="text" name="num" value="<?php echo $record[4];?>"><br>
Weights is:  <input type="text" name="weights" value="<?php echo $record[5];?>"><br>
photo is:  <input type="file" name="photo" value="<?php echo $record[6];?>"><br>
Description is:  <input type="text" name="descrip" value="<?php echo $record[7];?>"><br>
