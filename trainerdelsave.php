...
<body>
<center><h2>User Details Deleteion Saving Form</h2>
<form>
...
<?php
	...
	echo "<p>Speacilsation: <span>$h</span></p>";
        echo "<p>Experience: <span>$i</span></p>";
        echo "<p>Certification: <span>$j</span></p>";
	echo "<p>Working Days: <span>$k</span></p>";
	echo "<p>Working time: <span>$l</span></p>";
	echo "<p>Persoanl training fee: <span>$m</span></p>";
	echo "<p>Monthly fee: <span>$n</span></p>";
       


	$con=mysql_connect("localhost","root","");
	mysql_select_db("gym",$con);
        $sql="delete from trainers where buid=$a";
	mysql_query($sql);

	echo"<br>User Data Deleted Successfully...";
?>
<div class="buttons">
<a href="sermain.php">BACK</a>
</div>
