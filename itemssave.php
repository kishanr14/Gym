...
<body>
<center><h2>Items Details Updation Saving Form</h2>
<form>
...
<?php
	...
	echo "<p>Gym Name: <span>$h</span></p>";
        ...
        echo "<p>Number of equipment is: <span>$d</span></p>";
	echo "<p>Weights is: <span>$e</span></p>";
	...
	$sql="update items set gname='$h',items='$b', category='$c', num='$d',weights='$e', photo='$f',descrip='$g' where buid='$a'";
	mysql_query($sql);
