...
<body>
<center><h2>Searched Trainers Data For Modification</h2>
<?php
	$r=$_POST['buid'];
	...
	$sql="select * from trainers where buid='$r'";
	$rs=mysql_query($sql);
...
<form method="post" action="trainerssave.php">
...
profile is:  <input type="text" name="profi" value="<?php echo $record[5];?>"><br>
