...
<body>
<center><h2>Service Details Updation Saving Form</h2>
<form>
...
<?php
	...
	$sql="update service set gname='$h', gymtype='$b', package='$c', agelim='$d',descrip='$e', photo='$f',otime='$g', ctime='$h' where buid='$a'";
	mysql_query($sql);
